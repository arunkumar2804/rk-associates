  ...
  return (
    <header style={{ 
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '16px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 'none', textDecoration: 'none' }}>
        ...
        <nav style={{ display: 'flex', gap: 36, alignItems: 'center', flex: 1, justifyContent: 'center' }}>
          <Link to="/" style={{ fontSize: 14.5, fontWeight: 500, color: '#4A4038', textDecoration: 'none' }}>Home</Link>
          <Link to="/about" style={{ fontSize: 14.5, fontWeight: 500, color: '#4A4038', textDecoration: 'none' }}>About Us</Link>
          ...
          <Link to="/properties" style={{ fontSize: 14.5, fontWeight: 500, color: '#4A4038', textDecoration: 'none' }}>Properties</Link>
          <Link to="/blog" style={{ fontSize: 14.5, fontWeight: 500, color: '#4A4038', textDecoration: 'none' }}>Blog</Link>
          <Link to="/contact" style={{ fontSize: 14.5, fontWeight: 500, color: '#4A4038', textDecoration: 'none' }}>Contact Us</Link>
        </nav>
